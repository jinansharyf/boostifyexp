  ...
  head: () => ({
    meta: [
      ...
      { title: "Boostify — Delivary partner platform" },
      {
        name: "description",
        content:
          "Boostify helps business grow with a managed delivery and order operations platform.",
      },
      { name: "author", content: "Boostify" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { property: "og:title", content: "Boostify — Delivary partner platform" },
      { name: "twitter:title", content: "Boostify — Delivary partner platform" },
      { name: "description", content: "Boostify helps business grow with a managed delivery and order operations platform." },
      { property: "og:description", content: "Boostify helps business grow with a managed delivery and order operations platform." },
      { name: "twitter:description", content: "Boostify helps business grow with a managed delivery and order operations platform." },
    ...
    links: [
      ...
      { rel: "icon", href: "/__l5e/assets-v1/8a7ec683-440e-4754-9047-33cb3e6257df/boostify-logo.png", type: "image/png" },
      { rel: "shortcut icon", href: "/__l5e/assets-v1/8a7ec683-440e-4754-9047-33cb3e6257df/boostify-logo.png", type: "image/png" },
