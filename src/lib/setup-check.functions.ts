...
const CHECKS: { key: string; label: string; table: string; columns?: string[] }[] = [
  ...
  { key: "0006", label: "Password reset rate limit", table: "password_reset_attempts", columns: ["email", "created_at"] },
  { key: "0007a", label: "Vehicle types", table: "vehicle_types", columns: ["id", "code", "is_active"] },
  { key: "0007b", label: "Delivery prices matrix", table: "delivery_prices", columns: ["pickup_zone_id", "zone_id", "vehicle_type_id", "price_per_delivery"] },
  ...
  { key: "0007e", label: "Orders pricing columns", table: "orders", columns: ["partner_id", "pickup_zone_id", "dropoff_zone_id", "vehicle_type_id", "price_amount", "tracking_no"] },
  { key: "0008a", label: "Landing content", table: "landing_content", columns: ["section", "data"] },
  { key: "0008b", label: "Telegram settings", table: "telegram_settings", columns: ["bot_token", "chat_id"] },
